...
SELECT * FROM CALIFICACIONES;--RELACIONANDO A UN CURSOS EXPLICITO
DELETE FROM  CALIFICACIONES WHERE ID_CALIFICACION=2;
SELECT COUNT(*) FROM CALIFICACIONES;--RELACIONANDO A UN CURSOR IMPLICITO

--EJEMPLO DE CURSOS EXPLICITO CON LA TABLA DE CALIFIACIONES
